...
$collectWindowsAgentScript = Join-Path $workspaceRoot "scripts\collect-windows-agent-state.ps1"
...
& powershell.exe -NoProfile -ExecutionPolicy Bypass -File $collectWindowsAgentScript
